...
import { Button, Table, InputGroup, InputGroupButton, Input, ButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem, Pagination, PaginationItem, PaginationLink } from 'reactstrap';
...
class GoalList extends Component {
  ...
  componentDidMount() {
    goalRef.on('value', snap => {
      ...
      this.props.setGoals(goals.reverse());
  ...
  // changePage() {
  //   this.props.setGoals(this.state.goalslist.slice(this.state.startPage,this.state.endPage));
  // }
  //
  // allPages(e) {
  //   this.props.setGoals(this.state.goalslist);
  // }
  //
  // nextPage(e) {
  //   // this.props.setGoals(this.props.goals.reverse().slice(0, 10));
  //   // console.log(e.target.text);
  //   let newStartPage = this.state.startPage;
  //   let newEndPage = this.state.endPage;
  //   let pgNumberOld = this.state.activePage;
  //   // this.setState({pgNumber: (e.target.text)});
  //   // console.log(this.state.goalslist);
  //   if (e.target.text > pgNumberOld) {
  //     // console.log('+');
  //     newStartPage = newStartPage + 10;
  //     newEndPage = newEndPage + 10;
  //   } else {
  //     newStartPage = newStartPage - 10;
  //     newEndPage = newEndPage - 10;
  //     // console.log('-');
  //   }
  //   this.setState({activePage: e.target.text, startPage: newStartPage, endPage: newEndPage});
  //   // this.props.setGoals(this.state.goalslist.slice(this.state.startPage,this.state.endPage));
  //   console.log('pgNumberOld', pgNumberOld);
    ...
    return (
      <div>
        ...
        <Pagination className="justify-content-center">
          ...
          <PaginationItem className={this.state.activePage === '1' ? 'active' : ''}>
            <PaginationLink href="" onClick={(e) => this.nextPage(e)}>
              1
            </PaginationLink>
          </PaginationItem>
          <PaginationItem className={this.state.activePage === '2' ? 'active' : ''}>
            <PaginationLink href="" onClick={(e) => this.nextPage(e)}>
              2
            </PaginationLink>
          </PaginationItem>
          <PaginationItem className={this.state.activePage === '3' ? 'active' : ''}>
            <PaginationLink href="" onClick={(e) => this.nextPage(e)}>
              3
            </PaginationLink>
          </PaginationItem>
          <PaginationItem className={this.state.activePage === '4' ? 'active' : ''}>
            <PaginationLink href="" onClick={(e) => this.nextPage(e)}>
              4
            </PaginationLink>
          </PaginationItem>
          <PaginationItem  className={this.state.activePage === '5' ? 'active' : ''}>
            <PaginationLink href="" onClick={(e) => this.nextPage(e)}>
              5
            </PaginationLink>
          </PaginationItem>
          <PaginationItem  className={this.state.activePage === 'All' ? 'active' : ''}>
            <PaginationLink href="" onClick={(e) => this.allPages(e)}>
              All
            </PaginationLink>
          </PaginationItem>
          <PaginationItem>
